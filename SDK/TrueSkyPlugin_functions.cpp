...
void ATrueSkySequenceActor::SetKeyframeInt(int keyframeUid, const struct FString& Name, int Value)
{
...
void ATrueSkySequenceActor::SetKeyframeFloat(int keyframeUid, const struct FString& Name, float Value)
{
...
void ATrueSkySequenceActor::SetInt(const struct FString& Name, int Value)
{
...
void ATrueSkySequenceActor::SetFloat(const struct FString& Name, float Value)
{
...
int ATrueSkySequenceActor::GetKeyframeInt(int keyframeUid, const struct FString& Name)
{
...
float ATrueSkySequenceActor::GetKeyframeFloat(int keyframeUid, const struct FString& Name)
{
...
int ATrueSkySequenceActor::GetInt(const struct FString& Name)
{
...
float ATrueSkySequenceActor::GetFloat(const struct FString& Name)
{
